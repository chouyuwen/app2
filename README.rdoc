...
改（增加）頁面寬線
1.在css/tables/複製 class=‘table’/貼至views/topics/index.html.erb在第三行打<table class=‘table’>
在Getting started/Bosic tenplate/在Examples第一個starter temphte裏右鍵的檢查元素/點黑色部分/右邊語法會出現黑色部分的語法/複製/貼至Views/layouts/在22行空白處貼上（可能會變成疊字的錯誤）
改疊字
...
轉換字體
1.	在css上新增newfile，打上main.css(ctrl+s)，裡面打body{font-family:”微軟正黑體”，回到js/index.html，第五行<link rel=”stylesheet”type=”text/css” href=”css/bootstrap.css”>(bootstrap改成新增的文字檔名main)，接著app2/app/assets/stylesheets/application.scss(scss是更改後的檔名
接著開始利用新增的頁面去打內容
首頁設定
<li class="active"><a href=“http://localhost:3000/">首頁</a></li>

會員登入
先建立一個網頁
在app2/app/topics/welcome/打上<h1>會員登入</h1>

研討會報名系統

在app2/app/topics/welcome/打上<h1>研討會報名區</h1>

投稿區

在app2/app/topics/welcome/打上<h1>研討會投稿區</h1>
...
在app2/app/topics/welcome/打上<h3>此網站是提供各大專院校的師生能方便且快速的投稿</h3>
